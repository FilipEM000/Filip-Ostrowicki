...
public class Main {
    public static void main(String[] args) {
        ...
        Predicate<Event> isNameLong = event -> event.name().length() > 5;
        Predicate<Event> doesNameStartsWithF = event -> event.name().startsWith("f");
        Predicate<Event> isIdDivisibleByTwo = event -> event.id() % 2 == 0;
